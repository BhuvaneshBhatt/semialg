...
class CADCellIntegral:
    ...
    chart_mapping: tuple[tuple[sp.Symbol, sp.Expr], ...] = ()
    chart_variables: tuple[sp.Symbol, ...] = ()
    jacobian: sp.ImmutableMatrix | None = None
    gram_matrix: sp.ImmutableMatrix | None = None
...
def intrinsic_cell_integral(
    ...
    *,
    ...
    return CADCellIntegral(
        ...
        certified_bounds=cert.verify(),
        chart_mapping=tuple(mapping.items()),
        chart_variables=free_vars,
        jacobian=sp.ImmutableMatrix(jacobian),

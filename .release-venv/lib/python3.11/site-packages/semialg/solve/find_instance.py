    ...
    if strategy_name in {"auto", "ars"} and count == 1:
        ...
        if strategy_name == "ars":
            return _make_result(
                ...
                variables=vars_,
                domain=SolveDomain.REALS,
                method="ars_incomplete_instance",
                diagnostics=diagnostics,
                exact=True,
            )
    ...
    if dom is SolveDomain.REALS:
        ...
        if rur_result is not None and (
            ...
            if vs_result is not None and (
                ...
                result = vs_result
            elif parsed.quantifiers or strategy_name == "partial":
...
def find_instance_text(
    ...
    *,
    ...
    if not parsed.quantifiers and (strategy or "lazy").lower() == "lazy":

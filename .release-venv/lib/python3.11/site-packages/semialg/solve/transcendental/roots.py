...
def _support_points_intvls(intervals: Sequence[CertifiedIntervalRoot], lo: float, hi: float):
...
def decomp_univar_inequality(
    ...
    *,
    ...
    support = _support_points_intvls(certified_roots, search_window[0], search_window[1])

...
These routines are one-sided: success is a certified witness;
...
def odd_degree_negative_witness(
    ...
    for variable in vars_:
        ...
        # search is not interpreted as a mathematical conclusion.
        for radius in range(0, 8):
            ...
            for values in product(candidates, repeat=len(others)):
                ...
                if certified_zero(leading.subs(assignment)) is True:
                    continue

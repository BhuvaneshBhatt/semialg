...
def component_instances(
    ...
    *,
    ...
    """Return one deterministic exact sample mapping from each connected component.

    Representatives are selected deterministically from the computed CAD; they
    are not canonical points of the mathematical components and may change when
    CAD construction or sample-selection algorithms change. The default return
    is the tuple of mappings. Set ``return_result=True`` for component objects,
    status, and CAD diagnostics.
    """

...
def normalize_solve_variables(
    ...
    return tuple(sorted(formula.free_symbols - set(parameters), key=symbol_identity_key))
...
def prepare_solve_inputs(
    ...
    *,
    ...
    params = normalize_parameters(parameters, original)
    solve_vars = normalize_solve_variables(variables, original, params)
    if parameters is not None:
        undeclared = original.free_symbols - set(params) - set(solve_vars)
        if undeclared:
            names = ", ".join(

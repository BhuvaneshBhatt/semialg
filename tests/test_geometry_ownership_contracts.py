...
def _regions():
    ...
    tetra = TetrahedronRegion(((0, 0, 0), (1, 0, 0), (0, 1, 0), (0, 0, 1)))
    return (
        (Point((1, 2)), (1, 2)),
        ...
        (IntervalRegion(0, 2), (1,)),
        (BoxRegion(((0, 1), (0, 2))), (sp.Rational(1, 2), 1)),
        ...
        (ConicRegion((0, 0), rays=((1, 0), (0, 1))), (1, 1)),
        (tetra, (sp.Rational(1, 4),) * 3),
        (PolyhedronRegion((tetra,)), (sp.Rational(1, 4),) * 3),
        (ParallelogramRegion((0, 0), ((1, 0), (0, 2))), (sp.Rational(1, 2), 1)),
        (Parallelepiped((0, 0, 0), ((1, 0, 0), (0, 1, 0), (0, 0, 1))), (sp.Rational(1, 2),) * 3),
        (PrismRegion(triangle, (1, 1)), (sp.Rational(1, 2), sp.Rational(1, 2))),
        (PyramidRegion(triangle, (1, 1)), (sp.Rational(1, 3), sp.Rational(1, 3))),
        (Ball((0, 0), 2), (1, 0)),
        (Sphere((0, 0), 2), (2, 0)),
        (Ellipsoid((0, 0), ((4, 0), (0, 9))), (1, 0)),
        (EllipsoidBoundary((0, 0), ((4, 0), (0, 9))), (2, 0)),
        (SphericalShellRegion((0, 0), (1, 2)), (sp.Rational(3, 2), 0)),
        (Cylinder((0, 0, 0), (0, 0, 2), 1), (0, 0, 1)),
        (Cone((0, 0, 0), (0, 0, 2), 1), (0, 0, 1)),
        (Torus((0, 0, 0), 2, 1), (3, 0, 0)),
        (FilledTorus((0, 0, 0), 2, 1), (2, 0, 0)),
        (StadiumRegion((0, 0), (2, 0), 1), (1, 0)),
        (CapsuleRegion((0, 0, 0), (0, 0, 2), 1), (0, 0, 1)),

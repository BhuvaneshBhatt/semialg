...
def full_dimensional_solution_integrals(
    ...
    *,
    ...
    """Construct exact full-dimensional cell integrals for a cylindrical solution."""
...
def _section_mapping_and_jacobian(
    ...
    """Construct a section parametrization and exact metric Jacobian for intrinsic CAD integration."""
...
def intrinsic_solution_integrals(
    ...
    *,
    ...
    """Construct exact intrinsic cell integrals for a cylindrical solution."""
    cells = tuple(getattr(solution, "cells", ()))

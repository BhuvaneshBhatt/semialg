...
These functions intentionally compose the package's existing certified CAD/QE,
...
from .regions.operations import region_closure, region_dimension, region_interior
...
def minkowski_sum(left, right, variables=None) -> sp.Expr:

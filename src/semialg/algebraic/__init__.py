...
from .ideal_ops import elimination_ideal_qq, saturate_ideal_qq
...
from .thom import ThomEncoding, thom_encoding, thom_encodings
from .toric import (
    binomial_from_move,
    binomial_ideal,
    integer_kernel,
...
def refine_pair_until_disj(left: AlgebraicRoot, right: AlgebraicRoot, *, steps: int = 8):
    ...
    for _ in range(max(steps, 0)):
        ...
        lroot = refine_root_once(lroot, reason="separation")
        rroot = refine_root_once(rroot, reason="separation")
    return lroot.interval, rroot.interval
